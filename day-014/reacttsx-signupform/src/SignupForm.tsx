...
function App(): JSX.Element {
  ...
  const API_KEY: string = 'afb018d00c7ff8c27efbf756ac260853';
  ...
  const toggleTheme = (): void => {
    setThemeMode((prevMode: 'light' | 'dark') => (prevMode === 'light' ? 'dark' : 'light'));
  };
        ...
        <div className="App">
          <form onSubmit={handleSubmit}>
            ...
            <FormControl fullWidth sx={{ marginTop: 2 }}>
              <Button variant="contained" type="submit" color="secondary" disabled={loading}>Get Weather</Button>
            </FormControl>
          </form>
